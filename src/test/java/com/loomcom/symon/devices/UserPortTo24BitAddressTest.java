...
public class UserPortTo24BitAddressTest {
    ...
    public void checkAPU9() throws Exception {
        ...
        assertThat(memoryAddressByteSequence, contains(
                fromAddrValue(0x9800,0x01,0xa5) ,
                fromAddrValue(0x9801,0x01,0xe1) ,
                fromAddrValue(0x9802,0x01,0x16) ,
                fromAddrValue(0x9803,0x01,0xa5) ,
                fromAddrValue(0x9804,0x01,0x6f) ,
                fromAddrValue(0x9805,0x01,0xdb) ,
                fromAddrValue(0x9800,0x01,0xa5) ,
                fromAddrValue(0x9801,0x01,0xe1) ,
                fromAddrValue(0x9802,0x01,0x16) ,
                fromAddrValue(0x9803,0x01,0xa5) ,
