...
#    And the layer has 16 colours
    ...
    Given write data byte '0x90' to 24bit bus at '0x920b' and addressEx '0x01'
    ...
    Given write data byte '0xc4' to 24bit bus at '0x9210' and addressEx '0x01'
    Given write data byte '0x40' to 24bit bus at '0x9211' and addressEx '0x01'
    Given write data byte '0x80' to 24bit bus at '0x9212' and addressEx '0x01'
    Given write data byte '0xa0' to 24bit bus at '0x9213' and addressEx '0x01'
    ...
    Given write data byte '0x01' to 24bit bus at '0x9218' and addressEx '0x01'
    Given write data byte '0x20' to 24bit bus at '0x9219' and addressEx '0x01'
