...
#    When display until window closed
  ...
  Scenario: Sprites V9.5 32x32 mode select test
    ...
    Given video display does not save debug BMP images
    Given video display add joystick to port 1
    Given video display saves debug BMP images to leaf filename "target/frames/TC-9-95-"
    Given property "bdd6502.bus24.trace" is set to string "true"
    Given I have a simple overclocked 6502 system
    And That does fail on BRK
    And I enable uninitialised memory read protection with immediate fail
...
#    Given add a Sprites V9.5 layer with registers at '0x9800' and addressEx '0x10' and running at 12.096MHz
    ...
    Given write data byte '0x01' to 24bit bus at '0x9801' and addressEx '0x01'
    Given write data byte '0xc0' to 24bit bus at '0x9802' and addressEx '0x01'
    Given write data byte '0x0e' to 24bit bus at '0x9803' and addressEx '0x01'
    ...
    # Half width at VIDCLK
    Given write data byte '0x07' to 24bit bus at '0x985c' and addressEx '0x01'
    Given write data byte '0xd1' to 24bit bus at '0x985d' and addressEx '0x01'
    Given write data byte '0x60' to 24bit bus at '0x985e' and addressEx '0x01'
    Given write data byte '0x10' to 24bit bus at '0x985f' and addressEx '0x01'

    # From: TestData_DebugSprites.txt
    Given write data byte '0x00' to 24bit bus at '0x9860' and addressEx '0x01'
    Given write data byte '0x01' to 24bit bus at '0x9861' and addressEx '0x01'
    Given write data byte '0x50' to 24bit bus at '0x9862' and addressEx '0x01'
    Given write data byte '0x10' to 24bit bus at '0x9863' and addressEx '0x01'

    Given write data byte '0x00' to 24bit bus at '0x9864' and addressEx '0x01'
    Given write data byte '0x01' to 24bit bus at '0x9865' and addressEx '0x01'
    Given write data byte '0x40' to 24bit bus at '0x9866' and addressEx '0x01'
    Given write data byte '0x18' to 24bit bus at '0x9867' and addressEx '0x01'

    Given write data byte '0x00' to 24bit bus at '0x9868' and addressEx '0x01'
    Given write data byte '0x01' to 24bit bus at '0x9869' and addressEx '0x01'
    Given write data byte '0x30' to 24bit bus at '0x986a' and addressEx '0x01'
    Given write data byte '0x20' to 24bit bus at '0x986b' and addressEx '0x01'

    # Half width @ 14.31818MHz
    Given write data byte '0x00' to 24bit bus at '0x986c' and addressEx '0x01'
    Given write data byte '0x01' to 24bit bus at '0x986d' and addressEx '0x01'
    Given write data byte '0x20' to 24bit bus at '0x986e' and addressEx '0x01'
    Given write data byte '0x28' to 24bit bus at '0x986f' and addressEx '0x01'

    # Extra sprites at higher clock rates
    Given write data byte '0x00' to 24bit bus at '0x9870' and addressEx '0x01'
    Given write data byte '0x01' to 24bit bus at '0x9871' and addressEx '0x01'
    Given write data byte '0x50' to 24bit bus at '0x9872' and addressEx '0x01'
    Given write data byte '0x30' to 24bit bus at '0x9873' and addressEx '0x01'

    Given write data byte '0x00' to 24bit bus at '0x9874' and addressEx '0x01'
    Given write data byte '0x01' to 24bit bus at '0x9875' and addressEx '0x01'
    Given write data byte '0x40' to 24bit bus at '0x9876' and addressEx '0x01'
    Given write data byte '0x38' to 24bit bus at '0x9877' and addressEx '0x01'

    # Displayed at 16MHz
    Given write data byte '0x00' to 24bit bus at '0x9878' and addressEx '0x01'
    Given write data byte '0x01' to 24bit bus at '0x9879' and addressEx '0x01'
    Given write data byte '0x30' to 24bit bus at '0x987a' and addressEx '0x01'
    Given write data byte '0x40' to 24bit bus at '0x987b' and addressEx '0x01'

    # Not displayed, corrupt pixels on the left screen edge, single pixel on the left hand sprite edge
    Given write data byte '0x00' to 24bit bus at '0x987c' and addressEx '0x01'
    Given write data byte '0x01' to 24bit bus at '0x987d' and addressEx '0x01'
    Given write data byte '0x20' to 24bit bus at '0x987e' and addressEx '0x01'
    Given write data byte '0x48' to 24bit bus at '0x987f' and addressEx '0x01'
...
#    When display until window closed
    ...
    Then expect image "testdata/TC-9-95-000000.bmp" to be identical to "target/frames/TC-9-95-000000.bmp"
    Then expect image "testdata/TC-9-95-000010.bmp" to be identical to "target/frames/TC-9-95-000010.bmp"
    Then expect image "testdata/TC-9-95-000020.bmp" to be identical to "target/frames/TC-9-95-000020.bmp"
    Then expect image "testdata/TC-9-95-000030.bmp" to be identical to "target/frames/TC-9-95-000030.bmp"
    Then expect image "testdata/TC-9-95-000040.bmp" to be identical to "target/frames/TC-9-95-000040.bmp"
    Then expect image "testdata/TC-9-95-000050.bmp" to be identical to "target/frames/TC-9-95-000050.bmp"
    Then expect image "testdata/TC-9-95-000060.bmp" to be identical to "target/frames/TC-9-95-000060.bmp"
    Then expect image "testdata/TC-9-95-000070.bmp" to be identical to "target/frames/TC-9-95-000070.bmp"
    Then expect image "testdata/TC-9-95-000080.bmp" to be identical to "target/frames/TC-9-95-000080.bmp"
    Then expect image "testdata/TC-9-95-000090.bmp" to be identical to "target/frames/TC-9-95-000090.bmp"
    Then expect image "testdata/TC-9-95-000100.bmp" to be identical to "target/frames/TC-9-95-000100.bmp"
...
#    Given write data byte '0x00' to 24bit bus at '0x9c01' and addressEx '0x01'
  ...
  Scenario: Test chars image conversion output 2
    ...
    Given video display does not save debug BMP images
    Given video display add joystick to port 1
    Given video display saves debug BMP images to leaf filename "target/frames/TC-15-"
    Given property "bdd6502.bus24.trace" is set to string "true"
    Given I have a simple overclocked 6502 system
    And That does fail on BRK
    And I enable uninitialised memory read protection with immediate fail
    ...
    #../tmp/Demo9PaletteData.bin
    #../tmp/po0Demo9Chars2_plane
    #../tmp/po0Demo9Chars2_map.bin
    #../tmp/Demo9PaletteData5.bin
    #../tmp/po15Demo9Chars2_plane
    #../tmp/po15Demo9Chars2_map.bin

    # Use: convert6.bat
    # Palette
    Given write data from file "C:\work\c64\VideoHardware\tmp\Demo9PaletteData.bin" to 24bit bus at '0x9c00' and addressEx '0x01'
    # Clear first palette entry to black
#    Given write data byte '0x00' to 24bit bus at '0x9c00' and addressEx '0x01'
#    Given write data byte '0x00' to 24bit bus at '0x9c01' and addressEx '0x01'
    # Chars
    Given write data from file "C:\work\c64\VideoHardware\tmp\po0Demo9Chars2_plane0.bin" to 24bit bus at '0x2000' and addressEx '0x20'
    Given write data from file "C:\work\c64\VideoHardware\tmp\po0Demo9Chars2_plane1.bin" to 24bit bus at '0x4000' and addressEx '0x20'
    Given write data from file "C:\work\c64\VideoHardware\tmp\po0Demo9Chars2_plane2.bin" to 24bit bus at '0x8000' and addressEx '0x20'
    Given write data from file "C:\work\c64\VideoHardware\tmp\po0Demo9Chars2_plane3.bin" to 24bit bus at '0x0000' and addressEx '0x20'
    # Chars screen
    Given write data from file "C:\work\c64\VideoHardware\tmp\po0Demo9Chars2_map.bin" to 24bit bus at '0x4000' and addressEx '0x80'
    Given write data from file "C:\work\c64\VideoHardware\tmp\po0Demo9Chars2_map.bin2" to 24bit bus at '0x8000' and addressEx '0x80'

    # Debugging the wrong colours in the top of the horizontal beam
    # Is the palette wrong?
    Given write data byte '0x0e' to 24bit bus at '0x8298' and addressEx '0x80'
...
#    Given write data byte '0x00' to 24bit bus at '0x9c01' and addressEx '0x01'
    # Chars
    Given write data from file "C:\work\c64\VideoHardware\tmp\po15Demo9Chars2_plane0.bin" to 24bit bus at '0x2000' and addressEx '0x20'
    Given write data from file "C:\work\c64\VideoHardware\tmp\po15Demo9Chars2_plane1.bin" to 24bit bus at '0x4000' and addressEx '0x20'
    Given write data from file "C:\work\c64\VideoHardware\tmp\po15Demo9Chars2_plane2.bin" to 24bit bus at '0x8000' and addressEx '0x20'
    Given write data from file "C:\work\c64\VideoHardware\tmp\po15Demo9Chars2_plane3.bin" to 24bit bus at '0x0000' and addressEx '0x20'
    # Chars screen
    Given write data from file "C:\work\c64\VideoHardware\tmp\po15Demo9Chars2_map.bin" to 24bit bus at '0x4000' and addressEx '0x80'
    Given write data from file "C:\work\c64\VideoHardware\tmp\po15Demo9Chars2_map.bin2" to 24bit bus at '0x8000' and addressEx '0x80'

    # Debug char, for memory location funding purposes, visible in the last frame
    # In the middle of the top of the horizontal beam that has wrong colours
    #Given write data byte '0x00' to 24bit bus at '0x4298' and addressEx '0x80'
    ...
    Then expect image "testdata/TC-15-000000.bmp" to be identical to "target/frames/TC-15-000000.bmp"
    Then expect image "testdata/TC-15-000001.bmp" to be identical to "target/frames/TC-15-000001.bmp"
    Then expect image "testdata/TC-15-000002.bmp" to be identical to "target/frames/TC-15-000002.bmp"



  @TC-18
  Scenario: Test RGB bitmap display
    Given clear all external devices
    Given a new video display with overscan and 16 colours
    Given set the video display to RGB colour 5 6 5
    Given set the video display with 32 palette banks
    ...
    Given video display does not save debug BMP images
    Given video display add joystick to port 1
    Given video display saves debug BMP images to leaf filename "target/frames/TC-18-"
    Given property "bdd6502.bus24.trace" is set to string "true"
    Given I have a simple overclocked 6502 system
    And That does fail on BRK
    And I enable uninitialised memory read protection with immediate fail
