...
#    And I execute the procedure at start until return
    ...
    Then expect the next line to contain "d$80000202"
    Then expect the next line to contain "d$80010200"
    Then expect the next line to contain "d$80020200"
    Then expect the next line to contain "d$80030200"
    Then expect the next line to contain "d$80040200"
    Then expect the next line to contain "d$80050200"
    Then expect the next line to contain "d$80060200"
    Then expect the next line to contain "d$80070200"
    Then expect the next line to contain "d$20000200"
    Then expect the next line to contain "d$20000201"
    Then expect the next line to contain "d$20000203"
    Then expect the next line to contain "d$20000200"
    Then expect the next line to contain "d$00000000"
    ...
    When I execute the procedure at TestInterface_DMATransferAgain until return
    When I execute the procedure at TestInterface_DMATransferAgain2 until return
